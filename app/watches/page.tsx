...
export const metadata: Metadata = {
  title: 'Watch Sourcing Requests | Positive Watch HQ',
  description: 'Use Positive Watch HQ to source, sell, trade, or consign luxury watches. Demo examples show how private watch requests are reviewed before availability is confirmed.',
    ...
    <Container className="space-y-12 py-16 lg:py-20">
      <header className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-gradient-to-br from-white/[0.07] via-white/[0.025] to-amber-100/[0.08] p-8 shadow-[0_30px_90px_rgba(0,0,0,0.48)] md:p-12">
        ...
        <div className="relative max-w-4xl space-y-5">
          <p className="eyebrow">Private sourcing requests</p>
          <h1 className="max-w-4xl text-4xl font-semibold leading-tight tracking-[-0.045em] text-white sm:text-6xl">
            Source your next watch through a private review.
          </h1>
          <p className="max-w-3xl text-base leading-8 text-slate-300 sm:text-lg">
            Current watches shown here are request examples until specific availability is confirmed directly. Use this page to start a sourcing, trade, sell, or consignment review.
          </p>
        </div>
      </header>
      ...
      <section className="space-y-6">
        <div>
          ...
          <h2 className="mt-3 text-2xl font-semibold text-white">How to read this page before verified availability.</h2>
          <p className="mt-3 max-w-2xl text-sm leading-7 text-slate-300">Demo examples remain clearly labeled. Use brand browsing to start a sourcing request for a real reference.</p>
        </div>
      ...
      <section className="space-y-5">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {[
            ['Are all watches shown available?', 'Availability is confirmed before payment, trade terms, or shipment. Demo examples are clearly labeled when availability has not been confirmed.'],
            ['Can I trade toward a requested watch?', 'Yes. Submit your current watch details and we will review trade value, deal structure, and any cash difference.'],
