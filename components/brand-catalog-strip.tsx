...
export function BrandCatalogStrip() {
  return (
    <section id="brands" aria-labelledby="brands-and-requests" className="bg-[#020814] py-14 md:py-18 scroll-mt-28">
